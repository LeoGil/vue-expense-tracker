<template>
    ...
    <form>
        <div>
            ...
            <input class="border border-gray-300 rounded block text-xs p-2 w-full" type="text" id="text">
        </div>
        <div>
            <label class="inline-block mx-0 my-3 font-semibold" for="amount">Amount</label>
            <input class="border border-gray-300 rounded block text-xs p-2 w-full" type="number" id="amount">
        </div>
        <button
